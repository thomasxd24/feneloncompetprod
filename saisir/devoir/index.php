    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <form action="../../adddevoirsecure.php" method="post" id="wholedevoir" novalidate>
                                ...
                                <div class="box box-solid box-primary">
                                    ...
                                    <div class="box-body">
                                        <dl class="dl-horizontal center-block" style="width:70%">
                                            ...
                                            <dt>Classe*</dt>
                                            <dd>
                                                <select class="form-control" id="classchoose"  name="classid">
                                            ...
                                            <dt>Matiere*</dt>
                                            <dd>
                                                <select class="form-control" id="matierechoose" name="matiere">
                                                    <option selected value="" disabled>Selectionner une matiere</option>
                                                    <?php include("../../matiere/getmatiere.php"); ?>
                                                </select>
                                            </dd>
                                            <br>
                                            <dt>Date du Devoir</dt>
                                            <dd><div class="input-group date" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-language="fr">
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-calendar"></i>
                                                    </div>
                                                    <input type="text" name="datedevoir"  class="form-control pull-right" id="datepicker" value="<?php echo date('Y-m-d') ?>">
                                                </div>
                                            </dd>
                                            <br>
                                            <dt>Commentaire</dt>
                        ...
                        <div class="row setup-content " id="com5-1">
                            ...
                            <div class="col-md-12 col-xs-12">
                                <div class="box box-solid box-primary">
                                    <div class="box-header text-center">
                                        <h3 class="box-title">Domaine 5 - Representation du monde et l'actvite humaine</h3>
                                    </div><!-- /.box-header -->
                                    <div class="box-body">
                                    ...
                                    <div class="box-footer">
                                        <button type="button" id="activate-verify" class="btn btn-primary btn-lg">
                                            Vérifier L'intégralité du devoir
                                        </button>
                        ...
                        <div class="row setup-content " id="verify">
                            ...
                            <div class="col-md-12 col-xs-12">
                                <div class="box box-solid box-primary">
                                    <div class="box-header text-center">
                                        <h3 class="box-title">Vérification</h3>
                                    </div><!-- /.box-header -->
                                    <div class="box-body">
...
function checkallentered(){
  ...
  $('.inputs').each(function() {
     ...
     if(!contains){
       alert("Vous devez entrer au moins une competence d'un eleve.");
       return false
     }
     return true;
...
window.onbeforeunload = function(){
  return "Vous n'avez pas sauvegardé votre devoir. Êtes-vous sûr de quitter cette page?";
};
